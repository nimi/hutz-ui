...
function Tooltip(_ref) {
	var text = _ref.text,
	    ...
	    width = _ref.width,
	    color = _ref.color,
	    props = _objectWithoutProperties(_ref, ['text', 'backgroundColor', 'width', 'color']);
	...
	var _style = style({ bgc: bgc, c: c, width: width }),
	    ...
	    tooltip = _style.tooltip,
	    before = _style.before,
	    after = _style.after,
	    icon = _style.icon;
...
var style = function style(_ref2) {
	var _ref2$bgc = _ref2.bgc,
	    bgc = _ref2$bgc === undefined ? 'black' : _ref2$bgc,
	    _ref2$c = _ref2.c,
	    c = _ref2$c === undefined ? 'white' : _ref2$c,
	    width = _ref2.width;
	return {
		container: {
			cursor: 'default',
