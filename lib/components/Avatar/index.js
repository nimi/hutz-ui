...
function Avatar(_ref) {
	var src = _ref.src,
	    ...
	    props = _objectWithoutProperties(_ref, ['src', 'icon', 'letter', 'color', 'align', 'name', 'className', 'backgroundColor']);

	var nameAlign = name && ('left' || align);

	var _avatarStyle = avatarStyle({ src: src, nameAlign: nameAlign, backgroundColor: backgroundColor }),
	    containerStyle = _avatarStyle.containerStyle,
	    nameStyle = _avatarStyle.nameStyle;
	...
	return _react2.default.createElement(
		_Container2.default,
		{ fill: false, className: className || 'hutz-avatar' },
...
var avatarStyle = function avatarStyle(_ref2) {
	var src = _ref2.src,
	    nameAlign = _ref2.nameAlign,
	    _ref2$backgroundColor = _ref2.backgroundColor,
	    backgroundColor = _ref2$backgroundColor === undefined ? 'blue' : _ref2$backgroundColor;
	return {
		containerStyle: {
