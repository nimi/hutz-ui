...
function Dialog(_ref) {
	var open = _ref.open,
	    ...
	    fill = _ref.fill,
	    props = _objectWithoutProperties(_ref, ['open', 'backdropColor', 'onClose', 'fill']);

	var _style = style({ open: open, backdropColor: backdropColor, fill: fill }),
	    container = _style.container,
	    backdrop = _style.backdrop,
	    inner = _style.inner;
	...
	return _react2.default.createElement(
		_Container2.default,
		{
			fill: false,
			style: container,
			className: props.className || 'hutz-dialog'
		},
...
var style = function style(_ref2) {
	var _ref2$open = _ref2.open,
	    open = _ref2$open === undefined ? true : _ref2$open;
	return {
		container: {
			position: 'fixed',
			top: 0,
