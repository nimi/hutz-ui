...
function Pagination(_ref) {
	...
	var initialSelected = _ref.initialSelected,
	    ...
	    onPage = _ref.onPage,
	    props = _objectWithoutProperties(_ref, ['initialSelected', 'forceSelected', 'hrefPrefix', 'totalPages', 'previousLabel', 'nextLabel', 'breakLabel', 'totalMarginPagesDisplayed', 'totalPagesDisplayed', 'onPage']);
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ href: previousLink, onClick: function onClick(e) {
							return _this.props.onPage(e, selected - 1);
						}, style: style.button },
					previousLabel
				)
			),
