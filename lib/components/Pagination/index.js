...
var Pagination = function (_Component) {
  ...
  function Pagination(props) {
    ...
    var selected = typeof initialSelected === 'number' && initialSelected >= 0 ? initialSelected : typeof forceSelected === 'number' && forceSelected >= 0 ? forceSelected : 0;
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      var pageProps = (_props = this.props, initialSelected = _props.initialSelected, forceSelected = _props.forceSelected, hrefPrefix = _props.hrefPrefix, totalPages = _props.totalPages, previousLabel = _props.previousLabel, nextLabel = _props.nextLabel, breakLabel = _props.breakLabel, totalMarginPagesDisplayed = _props.totalMarginPagesDisplayed, totalPagesDisplayed = _props.totalPagesDisplayed, onPage = _props.onPage, _props);

      var styles = Object.assign({}, style.container, this.props.style);

      var Item = (0, _Item2.default)(pageProps);
      var pages = (0, _paginate2.default)(_extends({}, pageProps, { onPage: function onPage(e, s) {
          return _this2.handlePage(e, s);
        }, selected: selected })).reduce(function (prev, curr, i) {
        prev['key' + i] = Item(curr);
        return prev;
      }, {});

      var previousLink = selected === 0 ? '#' : hrefPrefix + selected;
      var nextLink = selected === totalPages - 1 ? '#' : hrefPrefix + (selected + 1);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Button2.default,
              { href: previousLink, onClick: function onClick(e) {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Button2.default,
              { href: nextLink, onClick: function onClick(e) {
